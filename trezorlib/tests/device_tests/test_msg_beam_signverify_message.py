...
class TestBeamSignVerifyMessage(TrezorTest):
    @pytest.mark.parametrize(
        "kid_idx, kid_sub_idx, message, nonce_pub_x, nonce_pub_y, sign_k, expected_is_valid", [
            ...
            [
                0, 0,
                "hello world",
                "94bb1f34c5e970136d4f1ff769e3332e4e5f430122ebe7e7720c754713adfab6", 1, "9f01b0eb202cd0780e35f0cf20c06cd930af8bb55db9c9c3e2146f34de1239d9",
                False
            ],
            [
                0, 1,
            ...
            [
                5, 2,
                "hello world",
                "fbf34c594f346f3937eb3306d70a0801d583c6c044311085f3a8f40b6195948a", 0, "2da2b290d11892bf88c590dd507fffb2a7c6660f269f2ca54dc661eebc1c758e",
                True
            ],
            [
                5, 2,
            ...
            [
                0, 0,
                "hello world",
                "758ce1a21710733f5dbb45cf0247d1600b0e19a1a4197a8327b9878ae8adb6ff", 1, "2f032c76a0ce00d8a4a5df48d5013c88878714e70facbfe6e76662eb45a75d61",
                True
            ],
            [
                1, 8,
                "hello from BEAM",
                "2a7b6b29252a13d6e06f92e3e25c783258749facbbcc994277bacbd6005adc03", 1, "7b0f586f092602ee9d49c191300a2a4a1c1c8bbc8d343add4c0194597f94fe7f",
                True
            ],
            [
                1, 8,
            ...
            [
                4, 4,
                "abcdefg",
                "cdf450609819f595e3b7c79d35ee48a0352f2999d1874258d31df57ba49b3aaf", 1, "583a10b35cac6efca6ea4a9776b364f281cb1830ef09424d24bf2619c20f8141",
                True
            ],
            [
                4, 5,
    ...
    def test_beam_verify_message_with_requested_pk_by_kid(self,
    ...
    def test_beam_verify_message_with_defined_pk(self,
